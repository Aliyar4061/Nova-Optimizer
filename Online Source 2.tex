...
\title{\centering Online Resource 2\\ \vspace{0.5cm} Datasets, Performance Comparisons, Visualizations, and Evaluation Metrics for the Nova Optimizer}
...
%\paragraph{Captions:}
%\begin{itemize}
%    \item Online Resource 1 (ESM\_1.pdf): Extended background on optimization methods and detailed mathematical derivations of the Nova optimizer.
%    \item Online Resource 2 (ESM\_2.pdf): Additional experimental results, including performance metrics, learning curves, confusion matrices, and ROC curves.
%\end{itemize}
%
%
%
...
%
%
%\section*{Guidelines for Addressing Online Sources (Supplementary Materials)}
%
%To address online sources (supplementary materials) according to the rules of journals, such as those outlined by Springer for Supplementary Information (SI), you need to follow specific guidelines for referencing, formatting, and submitting these materials. Below is a comprehensive guide based on the journal's requirements to ensure compliance and clarity.
%
%\subsection*{1. Referencing Supplementary Materials in the Main Manuscript}
%Supplementary materials must be cited in the main text of your manuscript whenever their content is relevant. The journal specifies that these should be referenced as ``Online Resource'' followed by a number. This allows readers to easily locate the corresponding supplementary file. Here's how to do it:
%
%\paragraph{Examples of Citations:}
%\begin{itemize}
%    \item For background information or derivations: ``For an extended background on deep learning optimization and mathematical derivations, see Online Resource 1.''
%    \item For additional results or figures: ``Additional experimental results, including performance metrics and figures, are provided in Online Resource 2.''
%    \item For multimedia content: ``As shown in the animation (Online Resource 3).''
%\end{itemize}
%
%\paragraph{Key Points:}
%\begin{itemize}
%    \item Use consecutive numbering (e.g., Online Resource 1, Online Resource 2) based on the order of supplementary files.
%    \item Ensure every mention in the text corresponds to a specific supplementary file listed in the manuscript's ``Supplementary Material'' section.
%\end{itemize}
%
%\subsection*{2. Including Required Metadata in Supplementary Files}
%Each supplementary file must contain specific information to meet journal standards. This ensures proper attribution and accessibility. Include the following in each file:
%
%\begin{itemize}
%    \item \textbf{Article Title:} The full title of your manuscript (e.g., ``Nova: A Novel Optimizer Integrating Nesterov Momentum, AMSGrad, and Decoupled Weight Decay for Deep Learning'').
%    \item \textbf{Journal Name:} The name of the journal (e.g., Springer Journal of Machine Learning Research---replace with the actual journal name).
%    \item \textbf{Author Names:} List all authors (e.g., Ali Zeydi Abdian, Mohammad Masoud Javidi, Najme Mansouri).
%    \item \textbf{Affiliation:} Institutional affiliations of the authors (e.g., Department of Computer Science, Shahid Bahonar University of Kerman, Kerman, Iran).
%    \item \textbf{Corresponding Author's Email:} Contact email (e.g., ali.zeydi.abdian@uk.ac.ir).
%\end{itemize}
%
%\paragraph{Verification:}
%Check your supplementary files (e.g., Online Source 1.pdf, Online Source 2.pdf). If any of these elements are missing (e.g., journal name), update the files accordingly.
%
%\subsection*{3. Providing Captions for Supplementary Files}
%In the ``Supplementary Material'' section of your manuscript, list each supplementary file with a concise caption describing its content. This helps readers understand what each file contains without needing to download it first. Examples based on typical content:
%
...
%\paragraph{Tips:}
%\begin{itemize}
%    \item Keep captions brief yet descriptive.
%    \item Match the numbering to the in-text references (e.g., Online Resource 1 in the text corresponds to Online Resource 1 in the list).
%\end{itemize}
%
%\subsection*{4. File Formats and Technical Requirements}
%The journal specifies acceptable file formats and technical constraints for supplementary materials. Ensure your files comply with these rules:
%
%\paragraph{Text and Figures:}
%\begin{itemize}
%    \item Use PDF format (e.g., ESM\_1.pdf, ESM\_2.pdf).
%    \item Avoid .doc or .ppt files, as they are not suitable for long-term viability.
%\end{itemize}
%
%\paragraph{Spreadsheets:}
%\begin{itemize}
%    \item Submit as .csv or .xlsx (e.g., ESM\_3.xlsx for complete results).
%\end{itemize}
%
%\paragraph{Audio, Video, and Animations:}
%\begin{itemize}
%    \item Supported formats: .avi, .wmv, .mp4, .mov, etc.
%    \item Aspect ratio: 16:9 or 4:3.
%    \item Maximum file size: 2 GB.
%    \item Minimum duration: 1 second.
%    \item Example: ESM\_2.mp4: Trajectory visualization of the Nova optimizer.
%\end{itemize}
%
%\paragraph{Specialized Formats:}
%\begin{itemize}
%    \item Formats like .pdb, .wrl, .nb, or .tex are allowed if relevant.
%\end{itemize}
%
%\paragraph{Multiple Files:}
%\begin{itemize}
%    \item Combine multiple files into a .zip or .gz file if needed (e.g., ESM\_4.zip for code and comparisons).
%\end{itemize}
%
%\paragraph{Naming Convention:}
%\begin{itemize}
%    \item Name files consecutively, such as ESM\_1.pdf, ESM\_2.pdf, etc., where ``ESM'' stands for Electronic Supplementary Material.
%\end{itemize}
%
%\subsection*{5. Submission Guidelines}
%When submitting supplementary materials:
%
%\begin{itemize}
%    \item Supply in Standard Formats: Use the formats listed above (PDF, MP4, XLSX, etc.).
%    \item Consider Download Times: Keep file sizes reasonable to avoid long download times for users. For large files (e.g., videos), ensure they are optimized while staying under 2 GB.
%    \item No Editing by Journal: Files will be published as submitted, so ensure they are polished and complete.
%\end{itemize}
%
%\subsection*{6. Accessibility Requirements}
%To make supplementary materials accessible to all readers:
%
%\begin{itemize}
%    \item Descriptive Captions: Already covered in the ``Supplementary Material'' section (see point 3).
%    \item Video Accessibility: Ensure videos do not flash more than three times per second to avoid triggering seizures. (This applies only if you submit video files like ESM\_2.mp4.)
%\end{itemize}
%
%\subsection*{7. Example Application+++++}
%Based on the provided documents (Online Source 1.pdf and Online Source 2.pdf), here's how you might address them:
%
%\paragraph{In the Main Manuscript:}
%\begin{itemize}
%    \item Introduction: ``For an extended background and detailed derivations of the Nova optimizer, see Online Resource 1.''
%    \item Results: ``Additional performance metrics, learning curves, and confusion matrices are available in Online Resource 2.''
%\end{itemize}
%
%\paragraph{Supplementary Material Section:}
%\begin{itemize}
%    \item Online Resource 1 (ESM\_1.pdf): Extended background and mathematical derivations of the Nova optimizer.
%    \item Online Resource 2 (ESM\_2.pdf): Additional experimental results, including tables, figures, and performance comparisons across datasets.
%\end{itemize}
%
%\paragraph{File Updates:}
%\begin{itemize}
%    \item Add the journal name to Online Source 1.pdf and Online Source 2.pdf if missing.
%    \item Confirm that other metadata (title, authors, affiliations, email) are present.
%\end{itemize}
%
%\subsection*{8. Handling Discrepancies}
%If your manuscript lists additional files (e.g., ESM\_2.mp4, ESM\_3.xlsx, ESM\_4.zip) not provided in the query, ensure consistency:
%
%\begin{itemize}
%    \item Update the manuscript to match the actual files (e.g., reassign Online Source 2.pdf as Online Resource 2 and adjust captions).
%    \item If additional files exist, apply the same rules (format, metadata, captions).
%\end{itemize}
%
%\section*{Conclusion}
%To comply with journal rules for supplementary information:
%
%\begin{itemize}
%    \item Reference supplementary materials in the text as ``Online Resource X.''
%    \item Include all required metadata (title, journal name, authors, affiliations, email) in each file.
%    \item List files with concise captions in the ``Supplementary Material'' section.
%    \item Use acceptable file formats (PDF, MP4, XLSX, etc.) and meet technical requirements (e.g., size limits for videos).
%    \item Ensure accessibility with descriptive captions and safe video content.
%\end{itemize}
%
%By following these steps, your supplementary materials will be properly addressed and compliant with the journal's guidelines.
%
...
\section*{Introduction of Online Resource 2 }

Online Resource 2 (ESM\_2.pdf) contains all experimental results and benchmarking data supporting this study.  Section~\ref{Sec 1} evaluates the time and space complexity of first-order optimizers, demonstrating Nova's superior computational efficiency.  Section \ref{Sec 2} details the datasets used for evaluation, while Section \ref{Sec 3} presents a systematic performance comparison of Nova against other optimizers across well-known neural architectures. Section \ref{Sec 4} provides confusion matrices for model predictions, and Section \ref{Sec 5} consolidates quantitative results: performance metrics (Subsection 5.1), learning curves and bar plots (Subsection 5.2), task-specific confusion matrices for CIFAR-10, MNIST, Noisy MNIST, and SST-2 (Subsection 5.3), and ROC-AUC analysis (Subsection 5.4). Together, these sections offer transparent, reproducible evidence of Nova’s efficacy, with visualizations and statistical metrics tailored for in-depth scrutiny.



\section{Time and Space Complexity of Common First‐Order Optimizers}\label{Sec 1}
...
%\section*{Online Resource 1: Extended Background on Deep Learning Optimization}
%
...
%\section*{Online Resource 2: Detailed Review of Optimization Methods}
%
...
%
%
%\section*{Online Resource 3: Research Gaps and Objectives of the Study}
%
%
%
...
%
%
%\section*{Online Resource 4: Novelties of the Proposed Method}
%
%
...
%
%
%\section*{Online Resource 5: Mathematical Breakdown of the Nova Optimizer}
%
%
...
%
%
%\section*{Online Resource 6: Key Enhancements in the Proposed Nova Optimizer}
%
...
%
%
%\section*{Online Resource 7: Why Nova Outperforms Other Optimizers?}
%
...
\section{Evaluating the Performance of Various Optimizers on Some Well-Known Networks: A Comparison
with Nova}\label{Sec 3}
...
\section{Confusion Matrix}\label{Sec 4}
